...
class FullyAsyncAgentData:
    ...
    def __init__(
        ...
        output: Optional[FullyAsyncAgentLoopOutput] = None,
    ):
...
class PartialToolAgentLoop(AgentLoopBase):
    @classmethod
    def init_class(cls, config, tokenizer, processor, **kwargs):
        if cls._class_initialized:
            return
        cls._class_initialized = True
        print("Performing class-level Partial ToolAgentLoop initialization")
    ...
    async def _handle_pending_state(self, agent_data: FullyAsyncAgentData, sampling_params: dict[str, Any]) -> AgentState:
        """Handle the pending state: prepare the prompt and start generation."""
        if not agent_data.output:
            ...
            if agent_data.output.is_cancel:
    ...
    async def _handle_generating_state(
        self, agent_data: FullyAsyncAgentData, sampling_params: dict[str, Any], ignore_termination: bool = False
    ) -> AgentState:
